      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="relative rounded-2xl bg-accent text-accent-foreground p-7 flex flex-col shadow-lg ring-1 ring-black/5 min-h-[220px]">
            <Wand className="absolute top-5 right-5 size-5 opacity-20" />
            <span className="inline-flex items-center w-fit gap-1.5 py-1 pl-1.5 pr-2.5 rounded-full text-[0.625rem] font-heading font-semibold uppercase tracking-widest mb-4 bg-deep text-accent">
              <Wand className="size-3 shrink-0" /> Best Value
            </span>
          ...
          <div className="relative rounded-2xl bg-magic text-white p-7 flex flex-col shadow-lg ring-1 ring-black/5 min-h-[220px]">
            ...
            <span className="inline-flex items-center w-fit gap-1.5 py-1 pl-1.5 pr-2.5 rounded-full text-[0.625rem] font-heading font-semibold uppercase tracking-widest mb-4 bg-white text-magic">
              <Wand className="size-3 shrink-0" /> Annual Plan
            </span>
            <h3 className="font-heading font-semibold uppercase text-2xl mb-3">
              Get Two Months Free
            </h3>
          ...
          <div className="relative rounded-2xl border-2 border-dashed border-primary/30 bg-primary/5 text-primary p-7 flex flex-col min-h-[220px]">
            <Gift className="absolute top-5 right-5 size-5 text-primary/30" />
            <span className="inline-flex items-center w-fit gap-1.5 py-1 pl-1.5 pr-2.5 rounded-full text-[0.625rem] font-heading font-semibold uppercase tracking-widest mb-4 bg-primary text-white">
              <Gift className="size-3 shrink-0" /> New Member Perk
            </span>
            <h3 className="font-heading font-semibold uppercase text-2xl mb-3">
              First Wash on Us
            </h3>
