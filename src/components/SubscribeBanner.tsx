  ...
  return (
    <section className="relative bg-background pt-0 pb-16 lg:pb-24">
      <div className="mx-auto max-w-7xl px-4 lg:px-6">
        <div className="relative rounded-[2rem] overflow-hidden bg-primary text-white shadow-2xl">

          {/* Subtle star field */}
          <Wand className="absolute top-6 left-8 w-6 h-6 text-white/10" />
          <Wand className="absolute bottom-10 left-1/2 w-4 h-4 text-accent/20" style={{ animationDelay: "0.6s" }} />
          <Wand className="absolute top-10 right-1/3 w-5 h-5 text-white/10" style={{ animationDelay: "1.2s" }} />
